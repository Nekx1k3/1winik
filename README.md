...
# 🟣 1win AutoBot /// HPV /// V2.08 🟣

| **Возможности**                                                    | **Поддерживается**  |
|----------------------------------------------------------------|:---------------:|
| **Многофункциональный** — *выполняет все те же действия, что вы делали бы руками:*<br>**—** *Выполнение заданий связанные с подписками*;<br>**—** *Сбор монет за рефералов*;<br>**—** *Получение ежедневной награды*;<br>**—** *Улучшение бустов `Запас энергии` и `Восстановление энергии`*;<br>**—** *Апгрейд всех карточек до максимально возможно уровня*;<br>**—** *30 минут беспрерывного тапания*;<br>**—** *Ожидание от 3 до 5 часов*;<br>**—** *Повторение действий через 3-5 часа.<br>Все действия выполняются в случайном порядке каждый раз, когда скрипт начинает сбор. Также добавлена пустая функция просмотра азартных игр 1win для большей правдоподобности* |✅|
...
- **Linux**
  ...
  - ```
    ...
    ```
  - ```
    pip3 install -r 1win/Core/Tools/HPV_Requirements.txt
    ```
- **Windows**
  ...
  - Запустится CMD в текущей директории. Далее просто вводим следующие команды:
    - ```
      ...
      ```
    - ```
      pip install -r 1win\Core\Tools\HPV_Requirements.txt
      ```
- **Android**
...
<br><br>
<details>
<summary><h1>🟡 Обновление за 18.08.2024</h1></summary>
  <ul>
    ...
    <li><strong>Теперь выполняются абсолютно все запросы на сервера 1win, даже те, что считаются бесполезными;</strong></li>
    <li><strong>Круглосуточная проверка обновлений и автоматическое обновление скрипта;</strong></li>
    <li><strong>Часовое тапанье изменено на получасовое;</strong></li>
    <li><strong>Изменение времени ожидания после получасового тапанья с 1-3 часов на случайное значение в диапазоне от 3 до 5 часов.</strong></li>
  </ul>
  <br>
  <strong>Обновление за 27.07.2024:</strong>
  <ul>
    <li><em>Обновлены все запросы;</em></li>
    <li><em>Добавлен апгрейд бустов `Запас энергии` и `Восстановление энергии`;</em></li>
    <li><em>Изменение времени ожидания после часового тапания с 1 часа на случайное значение в диапазоне от 1 до 3 часов.</em></li>
  </ul>
  <br>
